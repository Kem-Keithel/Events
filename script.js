document.addEventListener('DOMContentLoaded', () => {
    ...
    orderNowButton.addEventListener('click', (event) => {
        ...
        const productId = selectedPackage ? selectedPackage.querySelector('.details h3').textContent + " Diamonds(Events)" : 'Not selected'; // Get the selected package ID
